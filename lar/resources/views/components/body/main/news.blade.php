                                ...
                                @foreach($news as $newsItem)
                                    <div class="col-md-4 col-sm-4 col-xs-12  list-item box-blogs">
                                        <div class="border item-blogs clearfix">
                                            <div class="img-blogs">
                                                <a class="img-news" href="{{ route('news.detail',
                                                        ['news' => $newsItem->id, 'newsSlug' => Str::slug($newsItem->name)]) }}">
                                                    <img class="lazyload"
                                            ...
                                            <div class="info">
                                                <h2 class="title-blogs-item">
                                                    <a href="{{ route('news.detail',
                                                        ['news' => $newsItem->id, 'newsSlug' => Str::slug($newsItem->name)]) }}">{{ $newsItem->title }}</a></h2>
                                                <p class="more-blogs">
                                                    <span class="time">
